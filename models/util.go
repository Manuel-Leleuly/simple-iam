...
type NameRequest struct {
	FirstName string `gorm:"column:first_name;not null" json:"first_name" validate:"required,name"`
	LastName  string `gorm:"column:last_name" json:"last_name" validate:"name"`
}
